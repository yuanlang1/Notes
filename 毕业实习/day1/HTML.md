...
3. 开发工具：不限，选用个人习惯的即可（VSCode、EditPlus、PyCharm等）。
...
## 3. 常用结构标签
  ...
  - 表格标签
    ...
    - 行分组标签：可以将表格中的若干行划分为一组，表示表头<thead>，表尾<tfoot>及表格主体<tbody>，默认在表格中创建的所有行都会被自动加入<tbody>中
    ```html
...
# 课后作业
- 创建homework1.html，使用常用页面标签完成如下图所示页面
![homework-1](assets\hm1.png)
- 创建homework2.html，使用表单标签完成如下图所示页面
![homework-2](assets\hm2.png)
